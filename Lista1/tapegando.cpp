...
int main(int argc, char *argv[]) {
   ...
   for(int i = 0; i < quantEmpresas; i++){
       ...
       for (int j = 0; j < quantProcessos; j++) {
           ...
           int horasProcesso;
           cin >> horasProcesso;
           No *novo = new No(senhaMagistrado, horasProcesso, i);
   ...
   for (int l = 0; l < quantMagistrados; ++l) {
       cout << "Insira a horas do magistrado " << l;
   ...
   for (int k = 0; k < quantMagistrados; ++k) { //IMPRIMINDO PILHA
       cout << "Pilha " << (k+1) << ": ";
       pilha[k].print();
       cout << "" << endl;
   }
   ...
   cout << "Imprimindo pilha_________________________________________" << endl;
